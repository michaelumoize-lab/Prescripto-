  ...
  return (
    <div className='flex items-center justify-between py-4 mb-5 text-sm border-b border-b-gray-400'>
      ...
      <div className='flex items-center gap-4'>
        ...
        {/* Profile / Auth - Modified to check ONLY token */}
        {token
          ? (
            <div
            ...
            >
              ...
              <div
                className={`
                absolute top-0 right-0 z-20 pt-14
        ...
        {/* Mobile Menu */}
        <div
          className={`${showMobileMenu ? 'fixed w-full' : 'w-0 h-0'
        ...
        >
          ...
          <ul className='flex flex-col items-center gap-2 px-5 mt-5 text-lg font-medium'>
            ...
            <NavLink onClick={() => setShowMobileMenu(false)} to='/doctors'>
              <p className='inline-block px-4 py-2 rounded'>DOCTORS</p>
            </NavLink>
            ...
            {!token && (
              <button
                ...
                className='px-8 py-3 mt-4 text-base font-light text-white rounded-full bg-primary'
              >
                Create Account
              </button>
            )}
