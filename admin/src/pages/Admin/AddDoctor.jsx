      ...
      <div className="px-8 py-8 bg-white border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
        ...
        <div className="flex flex-col items-start gap-10 text-gray-600 lg:flex-row">
          ...
          <div className="flex flex-col w-full gap-4 lg:flex-1">
            ...
            <div className="flex flex-col flex-1 gap-1">
              <p>Speciality</p>
              <select onChange={(e) => setSpeciality(e.target.value)} value={speciality} className="px-3 py-2 border rounded" name="" id="">
        ...
        <div>
          ...
          <button type="submit" className="px-10 py-3 mt-4 text-sm text-white rounded-full bg-primary">Add Doctor</button>
      </div>
    </form>
  );
};
