  ...
  return (
    <div className="w-full max-w-6xl m-5">
      ...
      <div className="bg-white border rounded text-sm max-h-[80vh] overflow-y-scroll min-h-[60vh]">
        ...
        {/* Header row made STICKY */}
        <div className="hidden sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] grid-flow-col py-3 px-6 gap-1 border-b sticky top-0 bg-white z-10">
          <p>#</p>
          <p>Patient</p>
          <p>Payment</p>
          <p>Age</p>
        ...
        {appointments.map((item, index) => (
          ...
          >
            ...
            {item.cancelled ? (
              ...
              <p className="text-xs text-green-500 text-medium">Completed</p>
            ) : (
              <div className="flex">
                <img
