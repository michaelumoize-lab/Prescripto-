...
//API to get user appointmens for frontend
...
const deleteAccount = async (req, res) => {
    try {
        const { userId } = req.body; // userId comes from your auth middleware

        // Optional: You can also delete their appointments here if you want
